...
mod tests {
    ...
    fn test_brotli() {
        ...
        let brotli_recovered_table = EZTable::read_raw_binary("brotli", &brotli_decompressed).unwrap();
        let miniz_recovered_table = EZTable::read_raw_binary("miniz", &miniz_decompressed).unwrap();
